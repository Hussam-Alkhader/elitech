            ...
            <div class="header-top-wrp">
                <ul class="info">
                    <li><svg width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a class="ms-1">hello@elitechco.com</a>
                    </li>
                ...
                <ul class="link-info">
                    <li><a href="https://www.facebook.com/elitechco" target="_blank"><i class="fa-brands fa-facebook-f"></i></a></li>
                    <li><a href="https://www.instagram.com/elitechco?igsh=NjYwenowemU5ZzFn" target="_blank"><i class="fa-brands fa-instagram"></i></a></li>
                    <li><a href="https://www.linkedin.com/company/elitech-co/" target="_blank"><i class="fa-brands fa-linkedin-in"></i></a></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="main-menu">
                    <nav>
                        <ul>
                            ...
                            <li><a href="about.html" class="btn-menu">About</a></li>
                            <li>
                                <a href="service.html" class="btn-menu">Services</a>
                                <!-- <ul class="sub-menu">
                                    <li>
